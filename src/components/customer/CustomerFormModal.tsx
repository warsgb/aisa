...
export function CustomerFormModal({ isOpen, onClose, onSuccess }: CustomerFormModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-end sm:items-center justify-center">
      <div className="bg-white w-full sm:max-w-lg sm:rounded-xl shadow-2xl max-h-[90vh] overflow-hidden flex flex-col rounded-t-2xl">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
          ...
          {/* Footer */}
          <div className="px-4 py-3 border-t border-gray-100 flex justify-end gap-3 bg-gray-50/50">
            <button
              type="button"
              onClick={handleClose}
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-[#1677FF] rounded-xl hover:bg-[#4096FF] disabled:opacity-50 transition-colors"
            >
              {isSubmitting ? (
                <>提交中...</>
              ) : (
